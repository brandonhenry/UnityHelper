...
public: 
    ...
    // Rendering.LightProbeUsage lightProbeUsage;	
    ...
    // Rendering.ReflectionProbeUsage reflectionProbeUsage;
    ...
    // Rendering.ShadowCastingMode shadowCastingMode;	
    ...
    static Array<Material *> GetSharedMaterials(List<Material> m)
    {
        const MethodInfo* rendererGetSharedMaterials = class_get_method_from_name(rendererClass, "get_sharedMaterials", 0);
        return reinterpret_cast<Array<void *> *>(runtime_invoke(rendererGetSharedMaterials, Renderer::getKlass(), m, &exception));
    }
